...
private:
    ...
    static constexpr float BULLETS_OFFSET_X = UNIT_SIZE + 96;
    static constexpr float DUCKS_TEXT_OFFSET_X = UNIT_SIZE + 304;
    static constexpr float DUCKS_ICONS_OFFSET_X = UNIT_SIZE + 364;
    static constexpr float DUCKS_OFFSET_Y = UNIT_SIZE + 676;
    static constexpr float TARGET_OFFSET_Y = DUCKS_OFFSET_Y + 32;
    static constexpr float VALUES_OFFSET_Y = UNIT_SIZE + 666 + 38;
    static constexpr float TEXT_OFFSET_Y = UNIT_SIZE + 666;
